...
static char sccsid[]="@(#)ipcserver.c	4.3 96/05/24 jsloan@ncar.ucar.edu";

#include "libipc.h"

/*
**	ipcserver: establish a bound, unconnected socket on the local
**	host to the specified port.
**
**	Arguments:
